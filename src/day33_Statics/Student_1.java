...
public class Student_1 {
    ...
    public Student_1(String name, char gender) {
        this(name);
        this.gender = gender;
    }
    ...
    public Student_1(String name, int studentID, char grade) {
        this(name, studentID);
        this.grade = grade;
    }

    public Student_1(String name, char gender, int age) {
        this(name,gender);
        this.age = age;
    }

    public Student_1(String name, char gender, int age, int studentID) {
        this(name, gender, age);
        this.studentID = studentID;
    }

    public Student_1(String name, char gender, int age, int studentID, char grade) {
        this(name, gender, age, studentID);
        this.grade = grade;
    }

    public String toString() {//toString method instance methoddur
        return "Student_1{" +
                "name='" + name + '\'' +
                ", gender=" + gender +
                ", age=" + age +
