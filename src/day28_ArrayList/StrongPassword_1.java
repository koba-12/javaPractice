...
public class StrongPassword_1 {
    ...
    public static void main(String[] args) {
        ...
        boolean r2=false;//bu false lar geçici değerler//has upper case
        ...
        for (char each:chars){//arrayin(stringin)her bir karakterini loopla
            ...
            if (Character.isUpperCase(each)){
                ...
                r5=true;
            }else {//geriye sadewce special characterler kaldığından böyle yazdık-diğerlerinin hepsi trueysa buna da special char kalır.
                r4=true;
            }
        }
