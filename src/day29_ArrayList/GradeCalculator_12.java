...
public class GradeCalculator_12 {
    ...
    public static void main(String[] args) {
        ...
        gradeOfA.removeIf(p->!(p>=90 && p<=100));//90-100 arası dışındakileri out etmez
        ...
        System.out.println("Total number of A:"+gradeOfA.size());//toplam kaç tane A var-2
